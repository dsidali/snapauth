...
namespace WebApplication1.Controllers
{
    ...
    public class Auth2Controller : ControllerBase
    {
        ...
        public Auth2Controller(
            ...
            ILogger<Auth2Controller> logger)
        {
        ...
        /// <summary>
        /// Initiates the Snapchat OAuth2 authorization flow by redirecting to Snapchat
        /// </summary>
        [HttpGet("authorize")]
        public IActionResult Authorize([FromQuery] string userId = "default", [FromQuery] bool returnUrl = false)
        {
            try
            {
                ...
                // If returnUrl is true, return the URL as JSON instead of redirecting
                if (returnUrl)
                {
                    return Ok(new
                    {
                ...
                // Default behavior: redirect directly to Snapchat authorization
